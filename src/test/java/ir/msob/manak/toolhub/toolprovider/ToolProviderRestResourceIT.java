...
@Testcontainers
@CommonsLog
public class ToolProviderRestResourceIT
        extends DomainCrudRestResourceTest<ToolProvider, ToolProviderDto, ToolProviderCriteria, ToolProviderRepository, ToolProviderService, ToolProviderDataProvider>
    ...
    public Class<? extends BaseResource<String, User>> getResourceClass() {
        return ToolProviderRestResource.class;
    }
